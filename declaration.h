...
public:
    ...
    virtual const DoubleValue* execute(RunTimeData& __runTimeData) {
        return &_value; }
    virtual const DoubleValue* execute() {
        return &_value; }
...
public:
    ...
    virtual const StringValue* execute(RunTimeData& __runTimeData) {
        return &_value; }
    virtual const StringValue* execute() {
        return &_value; }
