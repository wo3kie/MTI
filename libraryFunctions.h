...
class _Pow:public FunctionDefinition{
    public:
        _Pow():FunctionDefinition(new DoubleValue(),"pow",new List<Parameter>(new List<Parameter>(new DoubleDeclaration("number",0,0)),new DoubleDeclaration("number",0,0)),0x00,0){
...
class _Printf:public FunctionDefinition{
    public:
        _Printf():FunctionDefinition(new DoubleValue(),"_printf",new List<Parameter>(new DoubleDeclaration("number",0,0)),0x00,0){
            // tworzy rekord aktywacji
...
class _Scanf:public FunctionDefinition{
    public:
        _Scanf():FunctionDefinition(new DoubleValue(),"_scanf",new List<Parameter>(new DoubleDeclaration("number",0,0)),0x00,0){
            // tworzy rekord aktywacji
            for( int parameter= 0; parameter<(int) _parameterList->size(); ++parameter){
                _activationRecord.valueList.push_back( (*_parameterList)[ parameter]->execute()->copy());
            }
...
class _Cos:public FunctionDefinition{
    public:
        _Cos():FunctionDefinition(new DoubleValue(),"cos",new List<Parameter>(new DoubleDeclaration("number",0,0)),0x00,0){
            // tworzy rekord aktywacji
            for( int parameter= 0; parameter<(int) _parameterList->size(); ++parameter){
                _activationRecord.valueList.push_back( (*_parameterList)[ parameter]->execute()->copy());
            }
...
class _Sin:public FunctionDefinition{
    public:
        _Sin():FunctionDefinition(new DoubleValue(),"sin",new List<Parameter>(new DoubleDeclaration("number",0,0)),0x00,0){
            // tworzy rekord aktywacji
            for( int parameter= 0; parameter<(int) _parameterList->size(); ++parameter){
                _activationRecord.valueList.push_back( (*_parameterList)[ parameter]->execute()->copy());
            }
...
class _Sqrt:public FunctionDefinition{
    public:
        _Sqrt():FunctionDefinition(new DoubleValue(),"sqrt",new List<Parameter>(new DoubleDeclaration("number",0,0)),0x00,0){
            // tworzy rekord aktywacji
            for( int parameter= 0; parameter<(int) _parameterList->size(); ++parameter){
                _activationRecord.valueList.push_back( (*_parameterList)[ parameter]->execute()->copy());
            }
...
class _Rad:public FunctionDefinition{
    public:
        _Rad():FunctionDefinition(new DoubleValue(),"rad",new List<Parameter>(new DoubleDeclaration("number",0,0)),0x00,0){
            // tworzy rekord aktywacji
            for( int parameter= 0; parameter<(int) _parameterList->size(); ++parameter){
                _activationRecord.valueList.push_back( (*_parameterList)[ parameter]->execute()->copy());
            }
...
class _Pi:public FunctionDefinition{
    public:
        _Pi():FunctionDefinition(new DoubleValue(),"pi",0x00,0x00,0){
        }
...
class _Read:public FunctionDefinition{
    public:
        _Read():FunctionDefinition(new StringValue(),"read",0x00,0x00,0){
        }
...
class _ParseDouble:public FunctionDefinition{
    public:
        _ParseDouble():FunctionDefinition(new DoubleValue(),"parseDouble",new List<Parameter>(new StringDeclaration("napis","",0)),0x00,0){
            // tworzy rekord aktywacji
            for( int parameter= 0; parameter<(int) _parameterList->size(); ++parameter){
                _activationRecord.valueList.push_back( (*_parameterList)[ parameter]->execute()->copy());
            }
